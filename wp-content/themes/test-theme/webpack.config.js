...
module.exports = (env, argv) => {
	...
	const projectConfig = {
		config: {
			...
			projectUrl: 'wp-landing-page.test', // Used for providing browsersync functionality.
			projectPath: 'wp-content/themes/test-theme', // Project path relative to project root.
		},
	};
