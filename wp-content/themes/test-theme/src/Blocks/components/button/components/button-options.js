		...
		<>
			...
			{buttonUse &&
				<>
					{showButtonColor &&
						<ColorPaletteCustom
							label={<IconLabel icon={icons.color} label={__('Color', 'test-theme')} />}
							value={buttonColor}
					...
					{showButtonIsLink &&
						<IconToggle
							icon={icons.link}
							label={__('Display as link', 'test-theme')}
					...
					{showButtonSize && !buttonIsLink &&
						<SimpleVerticalSingleSelect
							label={<IconLabel icon={icons.size} label={__('Size', 'test-theme')} />}
							options={sizeOptions}
						/>
					}
					...
					{showButtonWidth && !buttonIsLink &&
						<SimpleVerticalSingleSelect
							label={<IconLabel icon={icons.width} label={__('Width', 'test-theme')} />}
					...
					{showButtonAriaLabel &&
						<TextControl
							label={<IconLabel icon={icons.infoCircle} label={__('ARIA label', 'test-theme')} />}
					...
					{showButtonIsAnchor &&
						<IconToggle
							...
							help={__('Make sure to set the URL as an ID of the element you want to target, e.g. #my-block.', 'test-theme')}
						/>
					}

					{showButtonId &&
						<TextControl
							label={<IconLabel icon={icons.id} label={__('Unique identifier', 'test-theme')} />}
							value={buttonId}
