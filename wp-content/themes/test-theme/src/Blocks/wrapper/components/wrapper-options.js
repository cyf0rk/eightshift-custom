...
export const WrapperOptions = ({ attributes, setAttributes }) => {
	...
	return (
		<>
			{!wrapperDisable &&
				<PanelBody title={<span>{__('Layout', 'test-theme')}</span>} initialOpen={false} icon={icons.wrapper} className='es-panel-title'>
					...
					{(wrapperUse && wrapperUseSimpleShowControl) &&
						<IconToggle
							...
							label={__('Simple wrapper', 'test-theme')}
							checked={wrapperUseSimple}
							onChange={(value) => setAttributes({ wrapperUseSimple: value })}
							help={__('Provides only basic spacing and background options.', 'test-theme')}
						/>
					}
					...
					{wrapperUse &&
						<>
							...
							{showWrapperSpacingTop &&
								<Responsive label={<IconLabel icon={icons.spacingTop} label={__('Top spacing', 'test-theme')} />}>
							...
							{showWrapperSpacingBottom &&
								<Responsive label={<IconLabel icon={icons.spacingBottom} label={__('Bottom spacing', 'test-theme')} />}>
									{options.breakpoints.map((item, index) => {
										const point = ucfirst(item);
							...
							{showWrapperSpacingTopIn &&
								<Responsive label={<IconLabel icon={icons.spacingTopIn} label={__('Top inner spacing', 'test-theme')} />}>
									{options.breakpoints.map((item, index) => {
										const point = ucfirst(item);
							...
							{showWrapperSpacingBottomIn &&
								<Responsive label={<IconLabel icon={icons.spacingBottomIn} label={__('Bottom inner spacing', 'test-theme')} />}>
									{options.breakpoints.map((item, index) => {
										const point = ucfirst(item);
							...
							{showWrapperDividerTop &&
								<Responsive label={<IconLabel icon={icons.dividerTop} label={__('Top divider', 'test-theme')} />}>
									{options.breakpoints.map((item, index) => {
										const point = ucfirst(item);
							...
							{showWrapperDividerBottom &&
								<Responsive label={<IconLabel icon={icons.dividerBottom} label={__('Bottom divider', 'test-theme')} />}>
									{options.breakpoints.map((item, index) => {
										const point = ucfirst(item);
							...
							{showWrapperHide &&
								<Responsive label={<IconLabel icon={icons.hide} label={__('Hide', 'test-theme')} />}>
									{options.breakpoints.map((item, index) => {
										const point = ucfirst(item);
							...
							{showWrapperBackgroundColor &&
								<ColorPaletteCustom
									label={<IconLabel icon={icons.backgroundTypeAlt} label={__('Background color', 'test-theme')} />}
							...
							{!wrapperUseSimple &&
								<>
									{showWrapperWidth &&
										<Responsive label={<IconLabel icon={icons.width} label={__('Width', 'test-theme')} />}>
											{options.breakpoints.map((item, index) => {
									...
									{showWrapperOffset &&
										<Responsive label={<IconLabel icon={icons.offset} label={__('Offset', 'test-theme')} />}>
											{options.breakpoints.map((item, index) => {
									...
									{showWrapperContainerWidth &&
										<Responsive label={<IconLabel icon={icons.containerWidth} label={__('Container width', 'test-theme')} />}>
											{options.breakpoints.map((item, index) => {
												const point = ucfirst(item);
									...
									{showWrapperGutter &&
										<Responsive label={<IconLabel icon={icons.gutter} label={__('Gutter', 'test-theme')} />}>
											{options.breakpoints.map((item, index) => {
							...
							{showWrapperAnchorId &&
								<TextControl
									label={<IconLabel icon={icons.anchor} label={__('Block anchor ID', 'test-theme')} />}
							...
							{showWrapperId &&
								<TextControl
									label={<IconLabel icon={icons.id} label={__('Block unique identifier', 'test-theme')} />}
									value={wrapperId}
